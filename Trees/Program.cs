...
namespace Trees
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Expect 90: " + Harvest.HarvestTwoSections(new int[] { 20, 10, 0, 0, 20, 20, 20 }, 2, 3));
            Console.WriteLine("Expect 60: " + Harvest.HarvestTwoSections(new int[] { 10, 10, 0, 0, 20, 20, 0 }, 2, 3));
            Console.WriteLine("Expect 85: " + Harvest.HarvestTwoSections(new int[] { 10, 15, 0, 0, 20, 20, 20 }, 2, 3));
